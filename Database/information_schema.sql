...
--
-- Host: 127.0.0.1
-- Creato il: Mag 14, 2021 alle 17:21
...
--
-- Struttura stand-in per le viste `ALL_PLUGINS`
...
--
-- Struttura stand-in per le viste `APPLICABLE_ROLES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `CHARACTER_SETS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `CHECK_CONSTRAINTS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `CLIENT_STATISTICS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `COLLATIONS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `COLLATION_CHARACTER_SET_APPLICABILITY`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `COLUMNS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `COLUMN_PRIVILEGES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `ENABLED_ROLES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `ENGINES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `EVENTS`
-- (Vedi sotto per la vista effettiva)
--
CREATE TABLE `EVENTS` (
...
--
-- Struttura stand-in per le viste `FILES`
-- (Vedi sotto per la vista effettiva)
--
CREATE TABLE `FILES` (
`FILE_ID` bigint(4)
...
--
-- Struttura stand-in per le viste `GEOMETRY_COLUMNS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `GLOBAL_STATUS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `GLOBAL_VARIABLES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INDEX_STATISTICS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_BUFFER_PAGE`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_BUFFER_PAGE_LRU`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_BUFFER_POOL_STATS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_CMP`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_CMPMEM`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_CMPMEM_RESET`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_CMP_PER_INDEX`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_CMP_PER_INDEX_RESET`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_CMP_RESET`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_FT_BEING_DELETED`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_FT_CONFIG`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_FT_DEFAULT_STOPWORD`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_FT_DELETED`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_FT_INDEX_CACHE`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_FT_INDEX_TABLE`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_LOCKS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_LOCK_WAITS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_METRICS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_MUTEXES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_SYS_COLUMNS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_SYS_DATAFILES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_SYS_FIELDS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_SYS_FOREIGN`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_SYS_FOREIGN_COLS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_SYS_INDEXES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_SYS_SEMAPHORE_WAITS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_SYS_TABLES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_SYS_TABLESPACES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_SYS_TABLESTATS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_SYS_VIRTUAL`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_TABLESPACES_ENCRYPTION`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_TABLESPACES_SCRUBBING`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `INNODB_TRX`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `KEY_CACHES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `KEY_COLUMN_USAGE`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `OPTIMIZER_TRACE`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `PARAMETERS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `PARTITIONS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `PLUGINS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `PROCESSLIST`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `PROFILING`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `REFERENTIAL_CONSTRAINTS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `ROUTINES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `SCHEMATA`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `SCHEMA_PRIVILEGES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `SESSION_STATUS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `SESSION_VARIABLES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `SPATIAL_REF_SYS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `STATISTICS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `SYSTEM_VARIABLES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `TABLES`
-- (Vedi sotto per la vista effettiva)
--
CREATE TABLE `TABLES` (
`TABLE_CATALOG` varchar(512)
...
--
-- Struttura stand-in per le viste `TABLESPACES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `TABLE_CONSTRAINTS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `TABLE_PRIVILEGES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `TABLE_STATISTICS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `TRIGGERS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `USER_PRIVILEGES`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `USER_STATISTICS`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `user_variables`
-- (Vedi sotto per la vista effettiva)
--
...
--
-- Struttura stand-in per le viste `VIEWS`
-- (Vedi sotto per la vista effettiva)
--
CREATE TABLE `VIEWS` (
`TABLE_CATALOG` varchar(512)
...
--
-- Struttura per vista `ALL_PLUGINS`
--
...
--
-- Struttura per vista `APPLICABLE_ROLES`
--
...
--
-- Struttura per vista `CHARACTER_SETS`
--
...
--
-- Struttura per vista `CHECK_CONSTRAINTS`
--
...
--
-- Struttura per vista `CLIENT_STATISTICS`
--
...
--
-- Struttura per vista `COLLATIONS`
--
...
--
-- Struttura per vista `COLLATION_CHARACTER_SET_APPLICABILITY`
--
...
--
-- Struttura per vista `COLUMN_PRIVILEGES`
--
...
--
-- Struttura per vista `ENABLED_ROLES`
--
...
--
-- Struttura per vista `GEOMETRY_COLUMNS`
--
...
--
-- Struttura per vista `GLOBAL_STATUS`
--
...
--
-- Struttura per vista `GLOBAL_VARIABLES`
--
...
--
-- Struttura per vista `INDEX_STATISTICS`
--
...
--
-- Struttura per vista `INNODB_BUFFER_PAGE`
--
...
--
-- Struttura per vista `INNODB_BUFFER_PAGE_LRU`
--
...
--
-- Struttura per vista `INNODB_BUFFER_POOL_STATS`
--
...
--
-- Struttura per vista `INNODB_CMP`
--
...
--
-- Struttura per vista `INNODB_CMPMEM`
--
...
--
-- Struttura per vista `INNODB_CMPMEM_RESET`
--
...
--
-- Struttura per vista `INNODB_CMP_PER_INDEX`
--
...
--
-- Struttura per vista `INNODB_CMP_PER_INDEX_RESET`
--
...
--
-- Struttura per vista `INNODB_CMP_RESET`
--
...
--
-- Struttura per vista `INNODB_FT_BEING_DELETED`
--
...
--
-- Struttura per vista `INNODB_FT_CONFIG`
--
...
--
-- Struttura per vista `INNODB_FT_DEFAULT_STOPWORD`
--
...
--
-- Struttura per vista `INNODB_FT_DELETED`
--
...
--
-- Struttura per vista `INNODB_FT_INDEX_CACHE`
--
...
--
-- Struttura per vista `INNODB_FT_INDEX_TABLE`
--
...
--
-- Struttura per vista `INNODB_LOCKS`
--
...
--
-- Struttura per vista `INNODB_LOCK_WAITS`
--
...
--
-- Struttura per vista `INNODB_METRICS`
--
...
--
-- Struttura per vista `INNODB_MUTEXES`
--
...
--
-- Struttura per vista `INNODB_SYS_COLUMNS`
--
...
--
-- Struttura per vista `INNODB_SYS_DATAFILES`
--
...
--
-- Struttura per vista `INNODB_SYS_FIELDS`
--
...
--
-- Struttura per vista `INNODB_SYS_FOREIGN`
--
...
--
-- Struttura per vista `INNODB_SYS_FOREIGN_COLS`
--
...
--
-- Struttura per vista `INNODB_SYS_INDEXES`
--
...
--
-- Struttura per vista `INNODB_SYS_SEMAPHORE_WAITS`
--
...
--
-- Struttura per vista `INNODB_SYS_TABLES`
--
...
--
-- Struttura per vista `INNODB_SYS_TABLESPACES`
--
...
--
-- Struttura per vista `INNODB_SYS_TABLESTATS`
--
...
--
-- Struttura per vista `INNODB_SYS_VIRTUAL`
--
...
--
-- Struttura per vista `INNODB_TABLESPACES_ENCRYPTION`
--
...
--
-- Struttura per vista `INNODB_TABLESPACES_SCRUBBING`
--
...
--
-- Struttura per vista `INNODB_TRX`
--
...
--
-- Struttura per vista `KEY_CACHES`
--
...
--
-- Struttura per vista `KEY_COLUMN_USAGE`
--
...
--
-- Struttura per vista `OPTIMIZER_TRACE`
--
...
--
-- Struttura per vista `PARAMETERS`
--
...
--
-- Struttura per vista `PARTITIONS`
--
...
--
-- Struttura per vista `PROCESSLIST`
--
...
--
-- Struttura per vista `REFERENTIAL_CONSTRAINTS`
--
...
--
-- Struttura per vista `SCHEMA_PRIVILEGES`
--
...
--
-- Struttura per vista `SESSION_STATUS`
--
...
--
-- Struttura per vista `SESSION_VARIABLES`
--
...
--
-- Struttura per vista `SPATIAL_REF_SYS`
--
...
--
-- Struttura per vista `STATISTICS`
--
...
--
-- Struttura per vista `SYSTEM_VARIABLES`
--
...
--
-- Struttura per vista `TABLESPACES`
--
...
--
-- Struttura per vista `TABLE_CONSTRAINTS`
--
...
--
-- Struttura per vista `TABLE_PRIVILEGES`
--
...
--
-- Struttura per vista `TABLE_STATISTICS`
--
...
--
-- Struttura per vista `USER_PRIVILEGES`
--
...
--
-- Struttura per vista `USER_STATISTICS`
--
...
--
-- Struttura per vista `user_variables`
--
